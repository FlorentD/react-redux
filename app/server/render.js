...
var _manifestAssets = _interopRequireDefault(
  require('./static/manifest.assets.json')
);
...
function renderFullPage(req) {
  ...
  var FullApp = /*#__PURE__*/ _react.default.createElement(
  ...
  return (0, _ssr.getDataFromTree)(FullApp).then(function (content) {
    ...
    var styles = ['app.css'].map(function (file) {
      return '<link rel="stylesheet" href="'.concat(
        _manifestAssets.default[file],
        '"/>'
      );
    });
    var assets = ['vendors.js', 'app.js']
      .map(function (file) {
